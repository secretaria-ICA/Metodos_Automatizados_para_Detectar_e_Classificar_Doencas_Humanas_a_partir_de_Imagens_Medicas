...
* Balanceamento da base (removido) - Inicialmente foi feito o balanceamento da base para treinamento, atribuindo pesos a cada classe para evitar qualquer viés por meio de dados não balanceados. Durante os testes de configuração do modelo, a utilização dessa técnica mostrou-se ineficaz, pois diminuiu a performance do modelo na predição utilizando os dados de teste.
